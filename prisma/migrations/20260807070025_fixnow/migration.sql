...
-- CreateIndex
CREATE INDEX "bookings_technicianId_bookingDate_idx" ON "bookings"("technicianId", "bookingDate");
...
-- CreateIndex
CREATE INDEX "services_categoryId_price_idx" ON "services"("categoryId", "price");

-- CreateIndex
CREATE INDEX "services_technicianId_categoryId_idx" ON "services"("technicianId", "categoryId");
...
-- CreateIndex
CREATE INDEX "technician_profiles_hourlyRate_idx" ON "technician_profiles"("hourlyRate");
...
-- CreateIndex
CREATE INDEX "technician_profiles_location_isAvailable_idx" ON "technician_profiles"("location", "isAvailable");
